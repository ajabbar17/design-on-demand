...
const Recent = () => {
  ...
  return (
    ...
    >
      <motion.h1
        className="text-5xl md:text-8xl font-bold text-[#1a1a1a] tracking-normal uppercase"
        style={{ x: recentX, opacity }}
      >
        Recent
      </motion.h1>
      <motion.h1
        className="text-5xl md:text-8xl font-bold tracking-normal text-[#1a1a1a] uppercase"
        style={{ x: worksX, opacity }}
      >
        Works
      </motion.h1>
      <motion.p
        className="text-[#1a1a1a] text-lg md:text-2xl font-semibold mt-6 md:mt-9"
