...
const Projects = memo(({ img1, img2, title1, title2, tags1, tags2 }) => {
  ...
  return (
    <div className="w-full  flex gap-7 pt-8 pb-20 md:flex-row flex-col lg:px-12 xl:px-24 p-7">
      {/* Card 1 */}
      <div className="cardcontainer flex flex-col gap-4 w-full xl:w-1/2 h-auto xl:h-[75vh] rounded">
        <div ref={card1Ref} className="card w-full h-full relative">
          ...
          <Image
            src={img1}
            className="h-[40vh]  xl:w-[50vw] xl:h-[70vh]  object-fill rounded-xl"
            alt="Project 1"
            width={600}
            height={600}
            priority
      ...
      {title2 && (
        <div className="cardcontainer  flex flex-col gap-4 w-full xl:w-1/2 h-auto xl:h-[75vh] rounded">
          <div ref={card2Ref} className="card w-full h-full relative">
            ...
            <Image
              src={img2}
              className="xl:w-[50vw] h-[40vh] xl:h-[70vh] object-fill rounded-xl"
              alt="Project 2"
              width={600}
              height={600}
              priority
