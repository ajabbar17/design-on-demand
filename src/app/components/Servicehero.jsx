...
const Servicehero = () => {
  return (
    <section className="relative bg-[#f8f9fa] text-[#1a1a1a]">
      <div className="max-w-7xl mx-auto  px-6 py-20 grid md:grid-cols-2 items-center gap-12">
        ...
        <div className="space-y-6">
          ...
          <p className="text-gray-600 text-lg leading-relaxed">
            We transform your digital vision into reality. Our agency combines
            cutting-edge technology with creative strategy to deliver
